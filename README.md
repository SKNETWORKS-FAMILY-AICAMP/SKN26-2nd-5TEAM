...
```
<div align="left"> <img width="1507" height="1597" alt="Image" src="09_assets/wbs_.png" width="10%" height="10%"/> </div>
...
<table>
  ...
  <tr>
    ...
    <td>기획자로서의 시각으로 프로젝트 주제 선정, 자료 수집, 데이터전처리, PPT, 발표 등 과정 전반에 걸쳐 활약하는 모습이 인상적이었다.</td>
  </tr>
  <tr>
    <td align="center"><nobr>이창우</nobr></td>
  ...
  <tr>
    <td align="center"><nobr>정다솔</nobr></td>
    <td>데이터 수집과 전처리를 담당하며 분석의 토대를 마련해주셨고, 프로젝트의 기획과 PPT, 발표까지 직접 맡아 프로젝트의 마무리가 잘 될 수 있도록 큰 역할을 해주셨습니다. 복잡한 분석 내용을 이해하기 쉽게 정리하고 전달해주신 덕분에 프로젝트가 잘 마무리 되었습니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>김민하</nobr></td>
    <td>모델링 결과가 좋지 않을 때 새로운 데이터를 찾으려는 노력이 돋보였다.</td>
  </tr>
  <tr>
    <td align="center"><nobr>배재현</nobr></td>
  ...
  <tr>
    <td align="center"><nobr>정다솔</nobr></td>
    <td>기술적인 부분을 전반적으로 담당해주셨습니다. 코드가 체계적으로 정리된 덕분에 프로젝트 진행에 도움이 되었고 분석 환경을 만드는 데 중요한 역할을 해주셨습니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>김민하</nobr></td>
    <td>아이디어 뱅크로서 회의 때마다 의견을 내는 모습이 좋아보였다. </td>
  </tr>
  <tr>
    <td align="center"><nobr>배재현</nobr></td>
  ...
  <tr>
    <td align="center"><nobr>정다솔</nobr></td>
    <td>다양한 의견을 제시하며 협업 규칙을 체계적으로 정리해주셔서 프로젝트에 큰 도움이 되었습니다. 또한 머신러닝 모델 결과를 대시보드로 구현해서 직관적으로 확인할 수 있었습니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>김민하</nobr></td>
    <td>모델링 시 여러 각도에서 시도하는 모습이 보기좋았다. </td>
  </tr>
  <tr>
    <td align="center"><nobr>배재현</nobr></td>
  ...
  <tr>
    <td align="center"><nobr>정다솔</nobr></td>
    <td>GitHub 총괄 관리를 맡아 팀원들이 충돌 없이 협업할 수 있는 환경을 만들어주셨습니다. 모델링을 통해 핵심 예측 성능을 끌어올리는 데 크게 기여해주셨으며, 버전 관리가 체계적으로 이루어져 프로젝트 전반이 안정적으로 진행될 수 있었습니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>김민하</nobr></td>
    <td>프론트엔드 전반적으로 맡아서 진행하여 산출물을 도출하는 데에 있어 성공적으로 구축해주었다. </td>
  </tr>
  <tr>
    <td align="center"><nobr>배재현</nobr></td>
